...
export default function pagerReducer(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case PAGE_CHANGE:
      ...
      // console.log(
      //   "PagerReducer PAGE_CHANGE itemsPerPage, itemCount, currentPageIndex, pagerObj",state.itemsPerPage, 
      //   action.payload.itemCount,
      //   action.payload.pageIndex, 
      //   pagerObj);
      return pagerObj;
    ...
    case ITEMS_PER_PAGE_CHANGE:
      ...
      pagerObj = getPagerObj(
        ...
        0);
      // console.log(
      //   "PagerReducer ITEMS_PER_PAGE_CHANGE itemsPerPage, itemCount, currentPageIndex, pagerObj",action.payload.itemsPerPage, 
      //   action.payload.itemCount, 
      //   0, 
      //   pagerObj);
      return pagerObj;
    ...
    case FILTERSORT_APPLIED: 
      ...
      // console.log(
      //   "PagerReducer FILTERSORT_APPLIED itemsPerPage, itemCount, currentPageIndex, pagerObj",
      //   10, 
